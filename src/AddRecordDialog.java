...
public class AddRecordDialog extends JDialog implements ActionListener {
	...
	public Container dialogPane() {
		...
		empDetails.add(genderCombo = new JComboBox<String>(this.parent.gender),  LayoutManager.migLayout2);

		empDetails.add(new JLabel("Department:"), LayoutManager.migLayout1);
		empDetails.add(departmentCombo = new JComboBox<String>(this.parent.department), LayoutManager.migLayout2);
		...
		empDetails.add(fullTimeCombo = new JComboBox<String>(this.parent.fullTime),  LayoutManager.migLayout2);
